...
import communication.ttn.TTNCommunicationManager;
...
@Deprecated
public class TTNCommunicationManagerFactory {

    CommunicationHandler handler;
    int port;

    public TTNCommunicationManagerFactory(CommunicationHandler handler, int port) {
    ...
    public CommunicationManager create() {
        ...
        TTNCommunicationManager manager = new TTNCommunicationManager(handler, port);
