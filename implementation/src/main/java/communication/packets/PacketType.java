...
public enum PacketType {
    ...
    GET_ACTIVE_VOTING_REQUEST, GET_ACTIVE_VOTING_RESPONSE, INVALID_TOKEN, FAILURE, NO_PERMISSION, ADD_TOPIC_REQUEST, REMOVE_TOPIC_REQUEST, RENAME_TOPIC_REQUEST, REORDER_TOPIC_REQUEST;
}
