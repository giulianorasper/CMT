...
public enum PacketType {
    ...
    GET_ACTIVE_VOTING_REQUEST, GET_ACTIVE_VOTING_RESPONSE, INVALID_TOKEN, FAILURE, NO_PERMISSION, ADD_TOPIC_REQUEST, REMOVE_TOPIC_REQUEST, RENAME_TOPIC_REQUEST, REORDER_TOPIC_REQUEST, VALID_RESPONSE, REQUEST_OF_CHANGE_REQUEST, REQUEST_OF_SPEECH_REQUEST;
}
