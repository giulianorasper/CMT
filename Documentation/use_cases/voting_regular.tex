...
\begin{enumerate}
	...
	\item The server sends a notification to the client that the vote was counted, the user can still see the vote but cant submit anymore
	\item \underline{The user reloads the page}
	\item The application requests information regarding the voting
